...
username : agung-laksono811
status   : Student × Working Professional
based_in : Indonesia 🇮🇩

focus:
  - Web Development (Laravel, CodeIgniter, PHP, JavaScript)
  - Network Engineering (MikroTik, Cisco)
  - IoT Development (Arduino, Node-RED, MQTT)

currently:
  - 🎓 Pursuing degree while working professionally
  - 💼 Hands-on experience across web, network & IoT
...
| Project | Description | Stack | Role | Link |
|--------|-------------|-------|------|------|
| 📚 **Pakopintar LMS** | Corporate LMS for HR & L&D dept to improve employee knowledge on internal products & company improvements | CodeIgniter, PHP, MySQL, JS, SCSS | Fullstack (Backend-heavy) | 🔒 Private |
| 🌐 **AMTI Cipali** | Infrastructure monitoring & management web app | Laravel, Blade, MySQL | Fullstack Contributor | [→ View](https://github.com/naomimrg/amti_cipali) |
| 🌐 **AMTI AGS** | Web system for infrastructure operations | Laravel, PHP, MySQL | Fullstack Contributor | [→ View](https://github.com/naomimrg/amti_ags) |
| ⚡ **IoT Monitor** | Real-time sensor dashboard via MQTT + Grafana | Arduino, Node-RED, MQTT, Grafana | Solo Dev | 🔨 In Progress |
